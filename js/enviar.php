<?php 
    ...
    try {
        ...
        $mail->SMTPAuth = true;  
        $mail->Username = 'gustavo.fiorino@soluciones.webcorp.com.mx';  
        $mail->Password = 'Gu5t4v0.F10r1n0';  //contraseña para aplicacion                                                     
        $mail->SMTPSecure = 'ssl';  
        ...
        $mail->setFrom('gustavo.fiorino@soluciones.webcorp.com.mx', 'Gustavo Fiorino'); //desde donde se va a enviar
